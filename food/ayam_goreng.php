        ...
        <div class="row">
            ...
            <div class="content">
                <form action="../checkout.php?id_menu=<?= $menu["id_menu"]; ?>" method="POST">
                    ...
                    <b>Deskripsi:</b>
                    <p>Ayam goreng sering kali menjadi hidangan favorit dalam berbagai acara dan restoran, serta dapat disiapkan di rumah untuk dinikmati bersama keluarga dan teman-teman</p>

                    <b>Bahan-bahan:</b>
                    <ul>
                        <li>1 ekor ayam, potong menjadi beberapa bagian sesuai selra</li>
                    ...
                    <ol>
                        ...
                        <li>Campur semua bumbu halus dengan minyak wijen, merica, garam, kaldu jamur lalu aduk rata </li>
                        ...
                        <li>Panaskan minyak goreng diatas api sedang</li>
                        <li>Goreng ayam yang sudah dimarinasi hingga kecoklatan dan matang sempurna</li>
                        <li>Setelah ayamm matang, angkat dan tiriskan</li>
                        <li>Sajikan ayam goreng dengan sambel sesuai selera</li>
                    </ol>
