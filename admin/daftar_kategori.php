...
<html>
    ...
    <body>
        ...
        <section class="list" id="list">
            <h1 class="heading">DAFTAR <span>KATEGORI</span></h1>

            <a href="tambah_kategori.php" class="btn_tambah">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    <div class="image">
                        <img src="../image/<?= $row_kategori["gambar_kategori"] ?>"
                    alt="">
                    </div>
                    
                    <h3><?= $row_kategori["nama_kategori"]; ?></h3>
                    <p>Deskripsi: <?= $row_kategori["deskripsi_kategori"]; ?></p>
                    <a href="ubah_kategori.php?id_kategori=<?= $row_kategori["id_kategori"]; ?>" class="btn"> Ubah </a>
                    <a href="hapus_kategori.php?id_kategori=<?= $row_kategori["id_kategori"]; ?>" class="btn"> Hapus </a>
                </div>
