...
<html>
    ...
    <body>
        ...
        <section class="content">
            <h1 class="heading">UBAH <span>MENU</span></h1>
            <div class="row">
                <form action="" method="post" enctype="multipart/form-data">
                    <h3>Silahkan Ubah Menu</h3>
                    <table>
                        <input
                            type="hidden"
                            name="id_menu"
                            value="<?= $rows_menu['id_menu']; ?>"
                        />
                        <input
                            type="hidden"
                            name="id_kategori"
                            value="<?= $rows_menu['id_kategori']; ?>"
                        />
                        <input type="hidden" name="gambar_menu_lama" value="<?= $rows_menu["gambar_menu"]; ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                id="nama_menu" class="box" required value="<?= $rows_menu["nama_menu"]; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-box">
                            ...
                            <td>
                                ...
                                id="harga_menu" class="box" required value="<?= $rows_menu["harga_menu"]; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="text-box">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="id_kategori" name="id_kategori"  class="box">
